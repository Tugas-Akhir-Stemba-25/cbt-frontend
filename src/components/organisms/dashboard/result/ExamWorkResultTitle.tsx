...
import ExamWorkResultSidebar from './ExamWorkResultSidebar'

const ExamWorkResultTitle = () => {
  ...
  return (
    <Sheet>
      <div className="col-span-1 col-start-1 row-start-3 flex items-start justify-between gap-2 rounded-xl bg-background p-5 md:hidden">
        {isLoading ? (
      ...
      <SheetContent showX={false} className="w-[90%]">
        ...
        <ExamWorkResultSidebar />
      </SheetContent>
    </Sheet>
  )
}

export default ExamWorkResultTitle
